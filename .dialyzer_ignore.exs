[
  ...
  {"/Users/robert/prog.nosync/Sue/deps/nostrum/lib/nostrum/consumer.ex", :unknown_function},
  {"/home/runner/work/elixir/elixir/lib/elixir/lib/gen_server.ex", :callback_info_missing},
  {"lib/mock.ex", :no_return},

  # Subaru-related warnings
  {"lib/subaru.ex", :no_return},
  {"lib/subaru.ex", :call},
  {"lib/subaru/d_b.ex", :unknown_type},
  {"lib/subaru/query.ex", :unknown_type},
  {"lib/subaru/subgraph.ex", :unknown_type},
  {"lib/subaru/vertex.ex", :unknown_type},

  # Core Sue warnings
  {"lib/sue.ex", :pattern_match},
  ...
  {"lib/sue/models/account.ex", :unknown_type},
